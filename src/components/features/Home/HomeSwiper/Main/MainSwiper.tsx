    ...
    export default function MainSwiper({ prevButton, nextButton }: HomeSwiperProps) {
                                ...
                                <div className="w-full flex gap-3">
                                    ...
                                    <div className="relative flex flex-col flex-grow flex-wrap">
                                        ...
                                        <article className="hide-scrollbar hidden lg:block w-[90%] h-full max-h-[150px] overflow-y-scroll flex-wrap">
                                            <p className='text-sm'>Lorem ipsum dolor sit amet consectetur adipisicing elit.Debitis, omnis quaerat perferendis officia distinctio impedit, possimusreiciendis iure tempore natus exercitationem beatae, quisquam doloribus corporis!Quaerat et odit itaque earum!</p>
                                        </article>
