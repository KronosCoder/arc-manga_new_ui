  ...
  return (
    <section className='flex flex-col gap-5 my-6'>
        ...
        <div className="section__home">
            <div className="text-sm flex items-center gap-2 justify-start gap-1 bg-premium-dark text-white rounded-md py-2 px-2 transition-all duration-200 hover:bg-gray-700 cursor-pointer">
                <House size={24} />
